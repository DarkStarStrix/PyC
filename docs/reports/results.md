...
- `web/site/results/artifacts/` (all benchmark SVGs + `*.metadata.json`)
- `web/site/results/manifest.json` (full index)
- `web/site/results/latest-summary.json` (latest CPU/GPU summary)
